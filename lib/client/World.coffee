...
class World extends pulse.Sprite
  constructor: (args) ->
    ...
    throw new TypeError('assetManager is a required key in args and must be a pulse.AssetManager assetManager') unless args.assetManager instanceof pulse.AssetManager
