...
class World extends pulse.Sprite
  constructor: (args) ->
    throw new TypeError('assetManager is a required key in args and must be a pulse.AssetManager') unless args.assetManager instanceof pulse.AssetManager
    ...
    args     ?= {}
    args.src ?= @assetManager.getAsset('grass')
